...
public class FirstRatings {
	...
	public ArrayList<Rater> loadRaters(String filename){
		...
		try {
			...
			while((linha = conteudoCSV.readLine()) != null) {
				...
				ratings.add(new Rating(info[1],Double.parseDouble(info[2])));
				Rater rater = new Rater(info[0],ratings);
	...
	public void testLoadRaters() {
		ArrayList<Rater> raters = loadRaters("C:/Users/gsantiag/OneDrive - Capgemini/Desktop/Recommendation_System/ratings_short.csv");
